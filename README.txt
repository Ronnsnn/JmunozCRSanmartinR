...
- mul.c 	Multiplicación con arreglos de tipo char, requiere del programa funciones.c.
...
- script_mchar.sh 	Prueba la implementación mul.c
...
Además se encuentra una serie de archivos que sirven de complemento a los archivos ya presentados (imágenes de informes, tablas importadas, código de funciones utilizadas en un programa, etc).
...
- gcc mul.c -o mchar 		(compilación del código fuente mul.c)
...
- ./mchar A B r 	(A y B enteros de largo arbitrario, 'r' fijo)
...
el codigo fuente del archivo .tex, se encuentra en la carpeta /LaTeX, 
la cual solamente tiene que ser compilada por un editor de tex.
